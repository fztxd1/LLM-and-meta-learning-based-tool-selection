...
# random.seed(135246)  #test01
# random.seed(13524602) #test02
# random.seed(13524603) #test03
random.seed(13524604) #test04

parser = argparse.ArgumentParser()
parser.add_argument('--model_name', default=None, type=str, required=True, choices=['ChatGLM3', 'Chinese_LLaMa_Alpaca2_7B', 'Chinese_LLaMa_Alpaca2_13B'])
